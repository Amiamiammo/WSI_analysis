...
def get_args_parser():
    ...
    parser.add_argument("--logfile", default="training_dino", type=str, help="Please ignore and do not set this argument.")
    return parser
...
def train_dino(args, logger):
    ...
    # otherwise, we check if the architecture is in torchvision models
        ...
        logger.info(f"Unknow architecture: {args.arch}")
...
if __name__ == '__main__':
    ...
    logger.info("_______MAIN FUNCTION TRAINING DINO______")
